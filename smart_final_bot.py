...
def get_welcome_message():
    ...
    return (
        ...
        "💡 Бot автоматически проверяет заказы"
    )
                        ...
                        if text == "/start":
                            ...
                            if parser.worksheet:
                                ...
                                if active_orders:
                                    ...
                                    # Отправляем общую сумму в конце
                                    total_message = f"💰 *Общая сумма всех заказов: {total_amount:.2f} руб.*"
                                    send_message(chat_id, total_message)
